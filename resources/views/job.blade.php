...
<body>
    ...
    <section id="error-page" class="section-padding-70">
        <div class="container">
<div class="error-title" style="color:orange;">Our Clients are Looking for you!</div>
            <!-- Row -->
            <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12">
                    
                    <p>Throughout the year we are consistently recruiting across several sectors and levels junior to senior management. We are always on the lookout for creative and dynamic people to place in our client’s organisations. We hunt for  a range of  junior level to experienced people with skills gained across different sectors of the economy to fill roles. These roles include finance, HR, business support, engineering, sales and marketing, business development and commercial as well as operations management. We are continuously in search of experienced professionals from a wide range of disciplines who want to get more out of their career. For details of current openings, click the link below</p>
					<div >
	 	  <a  href ="{{route('job1')}}"class="btn btn-warning btn-lg">Current Vacancies</a>
	</div>
                     
                </div>
                <div class="col-md-4  col-sm-12 hidden-sm col-xs-12">
                    <p>We are not just looking for "anyone" to fill a role. We are looking for the best talent available. People with the drive and ambition to make the most of all the opportunities we offer and can match and then surpass our energy, vision and ideas. We are looking for people who would enable our clients remain the market leader in their chosen field
Can’t find any vacancy that fits your skills? Please update your resume and submit to recruitment@mml.com.ngwith the desired job title as the subjectto be considered for future opportunities. Candidates would only be contacted if their profile matches any suitable roles.
</p><br/> <br/>   <a href="{{route('job3')}}" class="btn btn-warning btn-lg">Future Openings</a>
                </div>
                <div class="col-md-4  col-sm-12 hidden-sm col-xs-12">
			...
			<div class="row col-md-offset-0" style="color:red;">
			<h4>Scam Alert</h4>
			<p>Neither MML nor any organisation that we recruit for solicits for financial payment through any of the stages of recruitment. MML would not be held liable for any losses if a candidate is a victim of this fraudulent practise.</p
			</div>
            <!-- Row End -->
        </div>
        <!-- end container -->
